(function (global, factory) {
	...
	(factory((global['@uirouter/angular'] = {}),global.ng.core,global.ng.common,global['@uirouter/core'],global.Rx,global.Rx,global.Rx.Observable,global.Rx.Observable,global.Rx.Observable,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.ng.router,global['@uirouter/rx']));
}(this, (function (exports,core,common,core$1,ReplaySubject,BehaviorSubject,of,fromPromise,combineLatest,switchMap,map,concat,router,rx) { 'use strict';
...
var UIView = /** @class */ (function () {
    ...
    UIView.prototype._applyInputBindings = function (factory, component, context, componentClass) {
        ...
        var implicitInputTuples = ng2ComponentInputs(factory)
            .filter(function (tuple) { return !core$1.inArray(explicitBoundProps, tuple.prop); });
...
var UISref = /** @class */ (function () {
    ...
    UISref.prototype.go = function (button, ctrlKey, metaKey) {
        if (this._anchorUISref && (this._anchorUISref.openInNewTab() || button || !core$1.isNumber(button) || ctrlKey || metaKey)) {
            return;
        }
...
function makeRootProviders(module) {
    return [
        ...
        { provide: core.APP_INITIALIZER, useFactory: onTransitionReady, deps: [core$1.TransitionService, UIROUTER_ROOT_MODULE], multi: true },
    ];
}
...
function loadModuleFactory(moduleToLoad, ng2Injector) {
    ...
    var offlineMode = compiler instanceof core.Compiler;
...
var Ng2LocationConfig = /** @class */ (function (_super) {
    ...
    function Ng2LocationConfig(router$$1, _locationStrategy) {
        var _this = _super.call(this, router$$1, core$1.is(common.PathLocationStrategy)(_locationStrategy)) || this;
        _this._locationStrategy = _locationStrategy;
        return _this;
    }
...
function uiRouterFactory(locationStrategy$$1, rootModules, modules, injector) {
    ...
    var router$$1 = new core$1.UIRouter();
    // Add RxJS plugin
    router$$1.plugin(rx.UIRouterRx);
    // Add $q-like and $injector-like service APIs
    router$$1.plugin(core$1.servicesPlugin);
    // ----------------- Monkey Patches ----------------
    // Monkey patch the services.$injector to use the root ng2 Injector
    core$1.services.$injector.get = injector.get.bind(injector);
    // ----------------- Configure for ng2 -------------
    router$$1.locationService = new Ng2LocationServices(router$$1, locationStrategy$$1, common.isPlatformBrowser(injector.get(core.PLATFORM_ID)));
...
var _UIROUTER_INSTANCE_PROVIDERS = [
    { provide: core$1.UIRouter, useFactory: uiRouterFactory, deps: [common.LocationStrategy, UIROUTER_ROOT_MODULE, UIROUTER_MODULE_TOKEN, core.Injector] },
...
Object.keys(core$1).forEach(function (key) { exports[key] = core$1[key]; });
